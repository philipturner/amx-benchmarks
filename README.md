...
- E-AMX stays the same as before, but slightly larger to support new ISA functionality. The lack of additional processing power makes the E-cores remain incredibly power-efficient.
